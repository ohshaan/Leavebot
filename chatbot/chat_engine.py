...
from leavebot.scripts.leave_utils import (
    total_leave_taken,
    leaves_by_type,
...
from leavebot.scripts.employee_utils import (
    years_of_service,
...
from leavebot.scripts.fetch_leave_history import fetch_leave_history  # now expects (emp_id, leave_types)
from leavebot.scripts.search_embeddings import search_embeddings  # RAG tool
